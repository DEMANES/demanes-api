...
public interface ObservationProvider {
	 ...
	 * 
	 * @param id
	 *            In order to resolve which Observation to invoke, the identity
	 *            of the corresponding Observation should be provided. To obtain
	 *            a list of available observations from this
	 *            ObservationProvider, use the {@linkplain #getObservations()}
	 *            function.
	 * @throws InexistentObservationID
	 *             If the provided id can not be resolved by the
	 ...
	 *             Is thrown if the observation cannot successfully obtain it's
	 *             information.
	 * 
	 * @see Observation#getValue()
	 */
	Object getValue(ANES_URN id) throws InexistentObservationID,
